# (PART) Python programming {.unnumbered}
...
#### Using %timeit: specifying number of runs and loops {.unnumbered}
...
#### Holistic conversion loop {.unnumbered}
...
#### Run differentials with .iterrows() {.unnumbered}
...
### Another iterator method: .itertuples() {.unnumbered}



#### Iterating with .itertuples() {.unnumbered}
...
#### Run differentials with .itertuples() {.unnumbered}
...
### pandas alternative to looping {.unnumbered}



#### Analyzing baseball stats with .apply() {.unnumbered}
...
#### Settle a debate with .apply() {.unnumbered}
...
### Optimal pandas iterating {.unnumbered}



#### Replacing .iloc with underlying arrays {.unnumbered}
...
#### Bringing it all together: Predict win percentage {.unnumbered}
...
```
##   Team League  Year   RS   RA   W    OBP    SLG     BA  Playoffs  RankSeason  RankPlayoffs    G   OOBP   OSLG    WP  WP_preds
...
## 4  CHC     NL  2012  613  759  61  0.302  0.378  0.240         0         NaN           NaN  162  0.335  0.424  0.38      0.39
```
</div>
...
#### What you have learned {.unnumbered}
