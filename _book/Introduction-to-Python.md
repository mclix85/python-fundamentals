# (PART) Python Fundamentals {.unnumbered}
...
### Hello Python! {.unnumbered}



#### The Python Interface {.unnumbered}
...
#### Python as a calculator {.unnumbered}
...
### Variables and Types {.unnumbered}
...
#### Calculations with variables {.unnumbered}
...
#### Other variable types {.unnumbered}
...
#### Operations with other types {.unnumbered}
...
#### Can Python handle everything? {.unnumbered}
...
#### Create list with different types {.unnumbered}
...
#### Select the valid list {.unnumbered}
...
#### Subset and calculate {.unnumbered}
...
#### Slicing and dicing (2) {.unnumbered}
...
#### Subsetting lists of lists {.unnumbered}
...
### Manipulating Lists {.unnumbered}



#### Replace list elements {.unnumbered}
...
#### Delete list elements {.unnumbered}
...
#### Inner workings of lists {.unnumbered}
...
## Functions and Packages {.unnumbered}
...
#### Different ways of importing {.unnumbered}
...
#### Baseball players' height {.unnumbered}
...
#### Baseball player's BMI {.unnumbered}
...
#### Lightweight baseball players {.unnumbered}
...
#### Subsetting NumPy Arrays {.unnumbered}
...
### 2D Numpy Arrays {.unnumbered}



#### Your First 2D NumPy Array {.unnumbered}
...
#### Baseball data in 2D form {.unnumbered}
...
#### Subsetting 2D NumPy Arrays {.unnumbered}
...
### Numpy: Basic Statistics {.unnumbered}



#### Average versus median {.unnumbered}
...
#### Explore the baseball data {.unnumbered}
...
#### Blend it all together {.unnumbered}
